...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-11-2022 a las 18:22:19
...
(1, 'Admin', NULL, NULL, 1, 1, 1),
(2, 'conse@conserje.com', NULL, NULL, 1, 1, 4);
...
--
ALTER TABLE `usuarios_tarjetas`
  MODIFY `idUserTarje` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
